 ...
 */
class CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'CodelyTv\\Apps\\Backoffice\\Backend\\Controller\\Courses\\CoursesGetController' => 'getCoursesGetControllerService',
            'CodelyTv\\Apps\\Backoffice\\Backend\\Controller\\HealthCheck\\HealthCheckGetController' => 'getHealthCheckGetControllerService',
            'CodelyTv\\Apps\\Backoffice\\Backend\\Controller\\Metrics\\MetricsController' => 'getMetricsControllerService',
            'CodelyTv\\Shared\\Infrastructure\\Elasticsearch\\ElasticsearchClient' => 'getElasticsearchClientService',
            'CodelyTv\\Tests\\Shared\\Infrastructure\\Behat\\ApiContext' => 'getApiContextService',
            'CodelyTv\\Tests\\Shared\\Infrastructure\\Behat\\ApplicationFeatureContext' => 'getApplicationFeatureContextService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 7).'/vendor/symfony/service-contracts/ServiceCollectionInterface.php';
            ...
            include_once \dirname(__DIR__, 7).'/vendor/symfony/http-kernel/EventListener/CacheAttributeListener.php';
            ...
            include_once \dirname(__DIR__, 7).'/vendor/psr/log/src/LoggerInterface.php';
            include_once \dirname(__DIR__, 7).'/vendor/psr/log/src/LoggerTrait.php';
            include_once \dirname(__DIR__, 7).'/vendor/psr/log/src/AbstractLogger.php';
            include_once \dirname(__DIR__, 7).'/vendor/symfony/http-kernel/Log/DebugLoggerInterface.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'CodelyTv\\Shared\\Infrastructure\\Symfony\\AddJsonBodyToRequestListener')] fn () => ($container->privates['CodelyTv\\Shared\\Infrastructure\\Symfony\\AddJsonBodyToRequestListener'] ??= new \CodelyTv\Shared\Infrastructure\Symfony\AddJsonBodyToRequestListener()), 'onKernelRequest'], 0);
        $instance->addListener('kernel.exception', [#[\Closure(name: 'CodelyTv\\Shared\\Infrastructure\\Symfony\\ApiExceptionListener')] fn () => ($container->privates['CodelyTv\\Shared\\Infrastructure\\Symfony\\ApiExceptionListener'] ?? $container->load('getApiExceptionListenerService')), 'onException'], 0);
        $instance->addListener('kernel.request', [#[\Closure(name: 'CodelyTv\\Shared\\Infrastructure\\Symfony\\BasicHttpAuthMiddleware')] fn () => ($container->privates['CodelyTv\\Shared\\Infrastructure\\Symfony\\BasicHttpAuthMiddleware'] ?? self::getBasicHttpAuthMiddlewareService($container)), 'onKernelRequest'], 0);
     ...
     */
    protected static function getInMemorySymfonyCommandBusService($container)
    {
        return $container->privates['CodelyTv\\Shared\\Infrastructure\\Bus\\Command\\InMemorySymfonyCommandBus'] = new \CodelyTv\Shared\Infrastructure\Bus\Command\InMemorySymfonyCommandBus(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\AuthenticateUserCommandHandler'] ?? $container->load('getAuthenticateUserCommandHandlerService'));
        }, 1));
    }

    /**
     * Gets the private 'CodelyTv\Shared\Infrastructure\Symfony\AddJsonBodyToRequestListener' shared autowired service.
     *
     * @return \CodelyTv\Shared\Infrastructure\Symfony\AddJsonBodyToRequestListener
     */
    protected static function getAddJsonBodyToRequestListenerService($container)
    {
        return $container->privates['CodelyTv\\Shared\\Infrastructure\\Symfony\\AddJsonBodyToRequestListener'] = new \CodelyTv\Shared\Infrastructure\Symfony\AddJsonBodyToRequestListener();
    }

    /**
     * Gets the private 'CodelyTv\Shared\Infrastructure\Symfony\BasicHttpAuthMiddleware' shared autowired service.
     *
     * @return \CodelyTv\Shared\Infrastructure\Symfony\BasicHttpAuthMiddleware
     */
    protected static function getBasicHttpAuthMiddlewareService($container)
    {
        return $container->privates['CodelyTv\\Shared\\Infrastructure\\Symfony\\BasicHttpAuthMiddleware'] = new \CodelyTv\Shared\Infrastructure\Symfony\BasicHttpAuthMiddleware(($container->privates['CodelyTv\\Shared\\Infrastructure\\Bus\\Command\\InMemorySymfonyCommandBus'] ?? self::getInMemorySymfonyCommandBusService($container)));
    }
    ...
    protected static function getControllerResolverService($container)
    {
        ...
        $instance->allowControllers(['CodelyTv\\Apps\\Backoffice\\Backend\\BackofficeBackendKernel', 'CodelyTv\\Apps\\Backoffice\\Backend\\Controller\\Courses\\CoursesGetController', 'CodelyTv\\Apps\\Backoffice\\Backend\\Controller\\HealthCheck\\HealthCheckGetController', 'CodelyTv\\Apps\\Backoffice\\Backend\\Controller\\Metrics\\MetricsController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer.xml'),
        ...
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'FriendsOfBehatSymfonyExtensionBundle' => [
                    'path' => (\dirname(__DIR__, 7).'/vendor/friends-of-behat/symfony-extension/src/Bundle'),
                    'namespace' => 'FriendsOfBehat\\SymfonyExtension\\Bundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer',
