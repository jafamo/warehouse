 ...
 */
class getMessenger_Listener_ResetServicesService extends CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 7).'/vendor/symfony/messenger/EventListener/ResetServicesListener.php';
