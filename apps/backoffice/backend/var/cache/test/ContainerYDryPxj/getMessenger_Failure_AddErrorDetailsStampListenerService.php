 ...
 */
class getMessenger_Failure_AddErrorDetailsStampListenerService extends CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 7).'/vendor/symfony/messenger/EventListener/AddErrorDetailsStampListener.php';
