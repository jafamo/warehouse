 ...
 */
class getMessenger_Middleware_DispatchAfterCurrentBusService extends CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 7).'/vendor/symfony/messenger/Middleware/DispatchAfterCurrentBusMiddleware.php';
