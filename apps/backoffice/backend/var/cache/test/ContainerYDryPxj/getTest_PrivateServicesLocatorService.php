 ...
 */
class getTest_PrivateServicesLocatorService extends CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'CodelyTv\\Shared\\Infrastructure\\Bus\\Command\\InMemorySymfonyCommandBus' => ['privates', 'CodelyTv\\Shared\\Infrastructure\\Bus\\Command\\InMemorySymfonyCommandBus', 'getInMemorySymfonyCommandBusService', false],
            ...
            'CodelyTv\\Shared\\Infrastructure\\Elasticsearch\\ElasticsearchClientFactory' => ['privates', 'CodelyTv\\Shared\\Infrastructure\\Elasticsearch\\ElasticsearchClientFactory', 'getElasticsearchClientFactoryService', true],
            ...
            'CodelyTv\\Shared\\Infrastructure\\Symfony\\BasicHttpAuthMiddleware' => ['privates', 'CodelyTv\\Shared\\Infrastructure\\Symfony\\BasicHttpAuthMiddleware', 'getBasicHttpAuthMiddlewareService', false],
            'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\AuthenticateUserCommandHandler' => ['privates', 'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\AuthenticateUserCommandHandler', 'getAuthenticateUserCommandHandlerService', true],
            'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\UserAuthenticator' => ['privates', 'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\UserAuthenticator', 'getUserAuthenticatorService', true],
            'CodelyTv\\Backoffice\\Auth\\Infrastructure\\Persistence\\InMemoryAuthRepository' => ['privates', 'CodelyTv\\Backoffice\\Auth\\Infrastructure\\Persistence\\InMemoryAuthRepository', 'getInMemoryAuthRepositoryService', true],
            'CodelyTv\\Backoffice\\Courses\\Application\\Create\\BackofficeCourseCreator' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\Create\\BackofficeCourseCreator', 'getBackofficeCourseCreatorService', true],
            'CodelyTv\\Backoffice\\Courses\\Application\\Create\\CreateBackofficeCourseOnCourseCreated' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\Create\\CreateBackofficeCourseOnCourseCreated', 'getCreateBackofficeCourseOnCourseCreatedService', true],
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchAll\\AllBackofficeCoursesSearcher' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\SearchAll\\AllBackofficeCoursesSearcher', 'getAllBackofficeCoursesSearcherService', true],
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchAll\\SearchAllBackofficeCoursesQueryHandler' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\SearchAll\\SearchAllBackofficeCoursesQueryHandler', 'getSearchAllBackofficeCoursesQueryHandlerService', true],
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchByCriteria\\BackofficeCoursesByCriteriaSearcher' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\SearchByCriteria\\BackofficeCoursesByCriteriaSearcher', 'getBackofficeCoursesByCriteriaSearcherService', true],
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchByCriteria\\SearchBackofficeCoursesByCriteriaQueryHandler' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\SearchByCriteria\\SearchBackofficeCoursesByCriteriaQueryHandler', 'getSearchBackofficeCoursesByCriteriaQueryHandlerService', true],
            'CodelyTv\\Backoffice\\Courses\\Infrastructure\\Persistence\\ElasticsearchBackofficeCourseRepository' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Infrastructure\\Persistence\\ElasticsearchBackofficeCourseRepository', 'getElasticsearchBackofficeCourseRepositoryService', true],
            ...
            'CodelyTv\\Shared\\Domain\\Bus\\Event\\EventBus' => ['privates', 'CodelyTv\\Shared\\Infrastructure\\Bus\\Event\\InMemory\\InMemorySymfonyEventBus', 'getInMemorySymfonyEventBusService', true],
            'CodelyTv\\Backoffice\\Courses\\Domain\\BackofficeCourseRepository' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Infrastructure\\Persistence\\ElasticsearchBackofficeCourseRepository', 'getElasticsearchBackofficeCourseRepositoryService', true],
            'CodelyTv\\Shared\\Domain\\Bus\\Command\\CommandBus' => ['privates', 'CodelyTv\\Shared\\Infrastructure\\Bus\\Command\\InMemorySymfonyCommandBus', 'getInMemorySymfonyCommandBusService', false],
            'CodelyTv\\Shared\\Domain\\Bus\\Command\\CommandHandler' => ['privates', 'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\AuthenticateUserCommandHandler', 'getAuthenticateUserCommandHandlerService', true],
            'CodelyTv\\Shared\\Domain\\Bus\\Event\\DomainEventSubscriber' => ['privates', 'CodelyTv\\Backoffice\\Courses\\Application\\Create\\CreateBackofficeCourseOnCourseCreated', 'getCreateBackofficeCourseOnCourseCreatedService', true],
            ...
            'CodelyTv\\Backoffice\\Auth\\Domain\\AuthRepository' => ['privates', 'CodelyTv\\Backoffice\\Auth\\Infrastructure\\Persistence\\InMemoryAuthRepository', 'getInMemoryAuthRepositoryService', true],
            ...
            'CodelyTv\\Shared\\Infrastructure\\Elasticsearch\\ElasticsearchClientFactory' => '?',
            ...
            'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\AuthenticateUserCommandHandler' => '?',
            'CodelyTv\\Backoffice\\Auth\\Application\\Authenticate\\UserAuthenticator' => '?',
            'CodelyTv\\Backoffice\\Auth\\Infrastructure\\Persistence\\InMemoryAuthRepository' => '?',
            'CodelyTv\\Backoffice\\Courses\\Application\\Create\\BackofficeCourseCreator' => '?',
            'CodelyTv\\Backoffice\\Courses\\Application\\Create\\CreateBackofficeCourseOnCourseCreated' => '?',
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchAll\\AllBackofficeCoursesSearcher' => '?',
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchAll\\SearchAllBackofficeCoursesQueryHandler' => '?',
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchByCriteria\\BackofficeCoursesByCriteriaSearcher' => '?',
            'CodelyTv\\Backoffice\\Courses\\Application\\SearchByCriteria\\SearchBackofficeCoursesByCriteriaQueryHandler' => '?',
            'CodelyTv\\Backoffice\\Courses\\Infrastructure\\Persistence\\ElasticsearchBackofficeCourseRepository' => '?',
            'controller_resolver' => '?',
            ...
            'CodelyTv\\Backoffice\\Courses\\Domain\\BackofficeCourseRepository' => '?',
            ...
            'CodelyTv\\Backoffice\\Auth\\Domain\\AuthRepository' => '?',
