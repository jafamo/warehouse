 ...
 */
class getConsole_Messenger_ExecuteCommandHandlerService extends CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 7).'/vendor/symfony/console/Messenger/RunCommandMessageHandler.php';
