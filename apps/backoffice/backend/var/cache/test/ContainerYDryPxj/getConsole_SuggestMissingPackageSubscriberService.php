 ...
 */
class getConsole_SuggestMissingPackageSubscriberService extends CodelyTv_Apps_Backoffice_Backend_BackofficeBackendKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 7).'/vendor/symfony/framework-bundle/EventListener/SuggestMissingPackageSubscriber.php';
