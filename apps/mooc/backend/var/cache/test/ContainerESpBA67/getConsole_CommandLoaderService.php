 ...
 */
class getConsole_CommandLoaderService extends CodelyTv_Apps_Mooc_Backend_MoocBackendKernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\MySql\\ConsumeMySqlDomainEventsCommand' => ['privates', '.CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\MySql\\ConsumeMySqlDomainEventsCommand.lazy', 'getConsumeMySqlDomainEventsCommand_LazyService', true],
            'CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\PublishDomainEventsFromMutationsCommand' => ['privates', '.CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\PublishDomainEventsFromMutationsCommand.lazy', 'getPublishDomainEventsFromMutationsCommand_LazyService', true],
            'CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\RabbitMq\\ConfigureRabbitMqCommand' => ['privates', '.CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\RabbitMq\\ConfigureRabbitMqCommand.lazy', 'getConfigureRabbitMqCommand_LazyService', true],
            'CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\RabbitMq\\ConsumeRabbitMqDomainEventsCommand' => ['privates', '.CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\RabbitMq\\ConsumeRabbitMqDomainEventsCommand.lazy', 'getConsumeRabbitMqDomainEventsCommand_LazyService', true],
            'CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand' => ['privates', '.CodelyTv\\Apps\\Mooc\\Backend\\Command\\DomainEvents\\RabbitMq\\GenerateSupervisorRabbitMqConsumerFilesCommand.lazy', 'getGenerateSupervisorRabbitMqConsumerFilesCommand_LazyService', true],
